...
export const difBeforeINI = '__fixtures__/ini/dif_before.ini';
export const difAfterINI = '__fixtures__/ini/dif_after.ini';
export const difBeforeYAML = '__fixtures__/yaml/dif_before.yaml';
export const difAfterYAML = '__fixtures__/yaml/dif_after.yaml';

export const difBeforeNestedJSON = '__fixtures__/json/nested_dif_before.json';
export const difAfterNestedJSON = '__fixtures__/json/nested_dif_after.json';
export const difBeforeNestedINI = '__fixtures__/ini/nested_dif_before.ini';
